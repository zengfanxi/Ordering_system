...
* 参数、调用方式、推荐结果如下：
  ```
    ...
    **kwargs:dict
    ...
    Examples
    --------
    >>> plan = Ordering_system(100,3,3,0.2,3,a='白菜',b='鸡',c='青菜')
    ...
    >>> plan = Ordering_system(100,3,5,0.2,3,a='白菜',b='鸡',c='青菜')
    >>> plan.recommend_f('/.../menu.xlsx')
    +------------------------------------------------------------------------+--------------------------------+----------+
    |                                  方案                                  |            菜品价格            | 菜品总价 |
    +------------------------------------------------------------------------+--------------------------------+----------+
    |     ['想吃土豆', '外婆下饭菜', '糖醋里脊', '外婆小炒', '香酥排腩']     | [16.0, 22.0, 22.0, 28.0, 32.0] |  120.0   |
    |    ['蛋黄板栗南瓜', '葱花肉', '番茄炒蛋', '精品小炒肉', '美味猪手']    | [22.0, 18.0, 16.0, 28.0, 36.0] |  120.0   |
    |  ['想吃土豆', '蛋黄板栗南瓜', '干煸四季豆', '精品小炒肉', '美味猪手']  | [16.0, 22.0, 18.0, 28.0, 36.0] |  120.0   |
    |   ['想吃土豆', '金蒜蒸娃娃菜', '糖醋里脊', '精品小炒肉', '美味猪手']   | [16.0, 18.0, 22.0, 28.0, 36.0] |  120.0   |
    | ['想吃土豆', '蛋黄板栗南瓜', '干煸四季豆', '雪菜蘑菇肉片', '美味猪手'] | [16.0, 22.0, 18.0, 28.0, 36.0] |  120.0   |
    +------------------------------------------------------------------------+--------------------------------+----------+
   ```
